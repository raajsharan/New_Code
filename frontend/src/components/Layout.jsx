...
const ADMIN_NAV = [
  ...
  { to: '/deleted-list',                 icon: Archive,    label: 'Deleted Items',              key: 'deleted-list' },
...
export default function Layout() {
  ...
  return (
    <div className="h-full w-full overflow-hidden bg-transparent p-3">
      ...
      {/* Main area */}
      <div className="flex-1 flex flex-col min-w-0 overflow-visible rounded-r-[22px] bg-white/35 dark:bg-slate-900/30">

        {/* Top bar */}
        <header className="glass-panel m-3 mb-2 h-[72px] flex items-center justify-between px-6 flex-shrink-0 relative z-30">
          <p className="text-sm text-gray-500 dark:text-slate-400 font-medium">{toolName}</p>
              ...
              <div className="absolute right-0 top-12 w-56
                ...
                <div className="flex items-center gap-3 px-4 py-3
                  ...
                  <div className="overflow-hidden">
                    ...
                    {user?.job_role && <p className="text-xs text-gray-400 dark:text-slate-500 truncate">{user.job_role}</p>}
                  </div>
                </div>
                <div className="py-1">
